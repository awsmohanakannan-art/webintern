    ...
    container.innerHTML = `
      <section class="section-padding" style="background-color: var(--color-gray-bg);">
        <div class="container" style="max-width: 640px;">
          <div style="background: white; border-radius: var(--radius-lg); padding: 40px 32px; border: 1px solid var(--color-border); box-shadow: var(--shadow-sm);">
            <div style="text-align: center; margin-bottom: 24px;">
              <span class="badge-sector" style="margin-bottom: 8px;">GET IN TOUCH</span>
              <h1 style="font-size: 32px; color: var(--color-blue-dark); margin-bottom: 6px;">Contact Support Team</h1>
              <p style="color: var(--color-gray-text); font-size: 14px; margin: 0;">
                Direct Support Email: <strong style="color: #0B3D91;">webinternsupport@gmail.com</strong>
              </p>
            </div>
            ...
            <form id="contact-form">
              ...
              <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                ...
                <div class="form-group">
                  ...
                  <input type="tel" id="contact-phone" class="form-input" placeholder="+91 9876543210" />
                </div>
              </div>

              <div class="form-group">
                <label class="form-label">Subject / Requirement Title</label>
                <input type="text" id="contact-subject" class="form-input" placeholder="e.g., Certificate Inquiry, Custom Track Requirement" />
              </div>

              <div class="form-group">
                <label class="form-label">Message / Requirement Details *</label>
                <textarea id="contact-message" class="form-input" rows="5" placeholder="Describe your questions or requirement details..." required></textarea>
              </div>

              <button type="submit" class="btn btn-primary btn-full btn-lg">Send Message to Support →</button>
            </form>
          </div>
        </div>
      </section>
