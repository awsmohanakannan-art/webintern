...
def save_master_record(data, record_id=None):
    ...
    if existing:
        ...
        execute_db("""
            ...
            WHERE id = ?
        """, (
            data.get("student_full_name").strip(),
            ...
            (data.get("internship_domain") or data.get("internship_position")).strip(),
            data.get("internship_position").strip(),
