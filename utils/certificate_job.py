...
def process_eligible_certificates():
    ...
    for app_record in apps:
        ...
        sync_certificate_to_google_sheets({
            ...
            "mobile": app_record.get('student_phone') or "",
            "phone_country_code": app_record.get('phone_country_code') or "",
            "college": app_record.get('student_college') or "",
            "department": app_record.get('student_dept') or "",
            "degree": app_record.get('student_degree') or "",
